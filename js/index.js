...
window.onload = function() {
	...
	numBounce(126, 150, numNode[0].children[1], '万', 1);
...
for (var i = 0; i < screenTwoItems.length; i++) {
 ...
 */
 ...
 var screenTwoItems = document.querySelector('.screen-three').querySelectorAll('a');
	...
	function wheel(type){
        ...
        if(curIndex > -7){
			...
			if(curIndex == -3 || curIndex == -5){
				next.style.backgroundImage = 'url(images/home/downWhite.png)'
			}else{
				next.style.backgroundImage = 'url(images/home/downGray.png)'
			}
			if(curIndex == -2){
